...
public class adapterSarana extends RecyclerView.Adapter<adapterSarana.ViewHolder> {
    private static final String TAG = "adapterPelayanan";
    private ArrayList<modelgaleri> datagaleri;
    private Context mContext;


    public adapterSarana(ArrayList<modelgaleri> datagaleri, Context context) {
    ...
    @NonNull
    @Override
    public adapterSarana.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.cardgambar, parent, false);
        return new adapterSarana.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull adapterSarana.ViewHolder holder, int position) {
