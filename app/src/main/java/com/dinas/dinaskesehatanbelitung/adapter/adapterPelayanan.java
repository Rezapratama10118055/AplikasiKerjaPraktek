...
public class adapterPelayanan extends RecyclerView.Adapter<adapterPelayanan.ViewHolder> {
    private static final String TAG = "adapterPelayanan";
    private ArrayList<modelgaleri> datagaleri;
    private Context mContext;


    public adapterPelayanan(ArrayList<modelgaleri> datagaleri, Context context) {
    ...
    @NonNull
    @Override
    public adapterPelayanan.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.cardgambar, parent, false);
        return new adapterPelayanan.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull adapterPelayanan.ViewHolder holder, int position) {
